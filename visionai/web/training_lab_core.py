...
TRAINING_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "smoking": {
        "id": "smoking",
        "title": "吸烟检测",
        "title_en": "Smoking detection",
        "description": "单类 smoking；部署为训练专模 models/specialists/smoking/",
        "description_en": "Single class smoking; deploys as specialist models/specialists/smoking/",
        "classes": ["smoking"],
    ...
    "safety_helmet": {
        ...
        "description_en": "0=no_helmet (violation), 1=helmet (comply); deploys as a violation specialist",
    ...
    "no_glasses": {
        ...
        "description_en": "0=no_glasses (violation), 1=glasses (comply); deploys as a violation specialist",
    ...
    "custom": {
        ...
        "description_en": "Enter your own classes; deploy as a specialist after training",
        "classes": [],
        "deploy_mode": "specialist",
        "deploy_target": None,
        "specialist_defaults": {
