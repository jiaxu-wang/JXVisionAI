...
CANONICAL_WRITE: Dict[str, Tuple[str, str]] = {
    ...
    "detect_burst_duration_ms": ("basic", "detect_burst_duration_ms"),
    "detect_burst_frames": ("basic", "detect_burst_frames"),
    "detect_burst_min_frames": ("basic", "detect_burst_min_frames"),
    "detect_burst_hit_ratio": ("basic", "detect_burst_hit_ratio"),
