...
节名与多数键名沿用历史前缀 ``visionai``，与 Python 包名 ``jxvisionai`` 相互独立。
"""
...
# .../jxvisionai/config/settings.py → 项目根
...
# Webhook：每路 alert_webhook_urls、alert_webhook_enabled（仅 Redis，见 jxvisionai/utils/alert_webhook.py）
